...
class BaseXMLParserTest(TestCase):
    ...
    def setUp(self):
        self.x = FileReader.read_file("dictionary/tests/resources/zootie.xml")
        ...
        self.zootie_sense_nt = SenseParsed(headword='zootie', slug='zootie', publish=True, xml_id='e11730_n_1', part_of_speech='noun', xml_dict={'@id': 'e11730_n_1', 'rhymes': {'rhyme': [{'@freq': '2', '#text': 'cutie'}]}, 'collocates': {'collocate': [{'@freq': '1', '@target': 'e3170_adj_1', '#text': 'blunted'}, {'@freq': '1', '@target': 'e9000_intrV_1', '#text': 'ride'}]}, 'domain': [{'@type': 'drugs'}, {'@type': 'marijuana'}], 'sentiment': {'@type': 'neutral'}, 'definition': [{'text': 'a marijuana cigarette laced with cocaine'}], 'synSetRef': {'@target': 'smokes'}, 'xref': [{'@type': 'hasSynonym', '@target': 'e8630_n_1', '#text': 'primo'}, {'@type': 'conceptRelatesTo', '@target': 'e8900_n_1', '#text': 'reefer'}], 'artists': {'artist': ['Black Sheep', 'Beastie Boys', 'De La Soul', 'RZA', 'Gang Starr']}, 'examples': {'example': [{'@id': '3470', 'date': '1989-07-25', 'artist': 'Beastie Boys', 'songTitle': 'Hey Ladies', '@spotUri': 'abc123', 'album': "Paul's Boutique", 'lyric': {'text': 'I met a little cutie, she was all hopped up on zootie', 'rhyme': [{'@rhymeTarget': 'e11730_n_1', '@position': '15', '@rhymeTargetWord': 'zootie', '@rhymeTargetPosition': '47', '#text': 'cutie'}], 'rf': [{'@target': 'e11730_n_1', '@position': '47', '@lemma': 'zootie', '#text': 'zootie'}]}}, {'@id': '5033', 'date': '1994-12-06', 'artist': 'Black Sheep', 'songTitle': 'We Boys', 'feat': ['Legion, The'], 'album': 'Non-Fiction', 'lyric': {'text': 'One love with the bang, riding with the zootie', 'xref': [{'@target': 'e9000_intrV_1', '@position': '24', '@lemma': 'ride', '#text': 'riding'}], 'rf': [{'@target': 'e11730_n_1', '@position': '40', '@lemma': 'zootie', '#text': 'zootie'}]}}, {'@id': '11290', 'date': '1996-07-07', 'artist': 'De La Soul', 'songTitle': 'Intro', 'album': 'Stakes Is High', 'lyric': {'text': 'Big four gets the zootie for the self', 'rf': [{'@target': 'e11730_n_1', '@position': '18', '@lemma': 'zootie', '#text': 'zootie'}]}}, {'@id': '17365', 'date': '1999-07-13', 'artist': 'Gang Starr', 'songTitle': 'Discipline', 'feat': ['Total'], 'album': 'Full Clip', 'lyric': {'text': 'Used to get blunted down in the hallways, I love the cutie pies, never the zootie pies', 'xref': [{'@target': 'e3170_adj_1', '@position': '12', '@lemma': 'blunted', '#text': 'blunted'}], 'rhyme': [{'@rhymeTarget': 'e11730_n_1', '@position': '53', '@rhymeTargetWord': 'zootie', '@rhymeTargetPosition': '75', '#text': 'cutie'}], 'rf': [{'@target': 'e11730_n_1', '@position': '75', '@lemma': 'zootie', '#text': 'zootie'}]}}, {'@id': '38936', 'date': '2003-10-07', 'artist': 'RZA', 'songTitle': 'A Day To God Is 1,000 Years (Stay With Me)', 'album': 'Birth of A Prince', 'lyric': {'text': 'Nigga, pass the zootie', 'rf': [{'@target': 'e11730_n_1', '@position': '16', '@lemma': 'zootie', '#text': 'zootie'}]}}]}}, definition='a marijuana cigarette laced with cocaine', notes='', etymology='')
        self.zootie_sense_nt_updated = SenseParsed(headword='zootie', slug='zootie', publish=True, xml_id='e11730_n_1', part_of_speech='noun', xml_dict={'@id': 'e11730_n_1', 'rhymes': {'rhyme': [{'@freq': '2', '#text': 'cutie'}]}, 'collocates': {'collocate': [{'@freq': '1', '@target': 'e3170_adj_1', '#text': 'blunted'}, {'@freq': '1', '@target': 'e9000_intrV_1', '#text': 'ride'}]}, 'domain': [{'@type': 'drugs'}, {'@type': 'marijuana'}], 'sentiment': {'@type': 'neutral'}, 'definition': [{'text': 'a marijuana cigarette laced with cocaine'}], 'synSetRef': {'@target': 'smokes'}, 'xref': [{'@type': 'hasSynonym', '@target': 'e8630_n_1', '#text': 'primo'}, {'@type': 'conceptRelatesTo', '@target': 'e8900_n_1', '#text': 'reefer'}], 'artists': {'artist': ['Black Sheep', 'Beastie Boys', 'De La Soul', 'RZA', 'Gang Starr']}, 'examples': {'example': [{'@id': '3470', 'date': '1989-07-25', 'artist': 'Beastie Boys', 'songTitle': 'Hey Ladies', '@spotUri': 'abc123', 'album': "Paul's Boutique", 'lyric': {'text': 'I met a little cutie, she was all hopped up on zootie', 'rhyme': [{'@rhymeTarget': 'e11730_n_1', '@position': '15', '@rhymeTargetWord': 'zootie', '@rhymeTargetPosition': '47', '#text': 'cutie'}], 'rf': [{'@target': 'e11730_n_1', '@position': '47', '@lemma': 'zootie', '#text': 'zootie'}]}}, {'@id': '5033', 'date': '1994-12-06', 'artist': 'Black Sheep', 'songTitle': 'We Boys', 'feat': ['Legion, The'], 'album': 'Non-Fiction', 'lyric': {'text': 'One love with the bang, riding with the zootie', 'xref': [{'@target': 'e9000_intrV_1', '@position': '24', '@lemma': 'ride', '#text': 'riding'}], 'rf': [{'@target': 'e11730_n_1', '@position': '40', '@lemma': 'zootie', '#text': 'zootie'}]}}, {'@id': '11290', 'date': '1996-07-07', 'artist': 'De La Soul', 'songTitle': 'Intro', 'album': 'Stakes Is High', 'lyric': {'text': 'Big four gets the zootie for the self', 'rf': [{'@target': 'e11730_n_1', '@position': '18', '@lemma': 'zootie', '#text': 'zootie'}]}}, {'@id': '17365', 'date': '1999-07-13', 'artist': 'Gang Starr', 'songTitle': 'Discipline', 'feat': ['Total'], 'album': 'Full Clip', 'lyric': {'text': 'Used to get blunted down in the hallways, I love the cutie pies, never the zootie pies', 'xref': [{'@target': 'e3170_adj_1', '@position': '12', '@lemma': 'blunted', '#text': 'blunted'}], 'rhyme': [{'@rhymeTarget': 'e11730_n_1', '@position': '53', '@rhymeTargetWord': 'zootie', '@rhymeTargetPosition': '75', '#text': 'cutie'}], 'rf': [{'@target': 'e11730_n_1', '@position': '75', '@lemma': 'zootie', '#text': 'zootie'}]}}, {'@id': '38936', 'date': '2003-10-07', 'artist': 'RZA', 'songTitle': 'A Day To God Is 1,000 Years (Stay With Me)', 'album': 'Birth of A Prince', 'lyric': {'text': 'Nigga, pass the zootie, yo', 'rf': [{'@target': 'e11730_n_1', '@position': '16', '@lemma': 'zootie', '#text': 'zootie'}]}}]}}, definition='a marijuana cigarette laced with cocaine', notes='', etymology='')
        ...
        self.zootie_example_nt = ExampleParsed(primary_artists='Beastie Boys', song_title='Hey Ladies', featured_artists=[], release_date='1989-07-25', release_date_string='1989-07-25', album="Paul's Boutique", lyric_text='I met a little cutie, she was all hopped up on zootie', xml_id='3470', xrefs=[], rfs=[{'@target': 'e11730_n_1', '@position': '47', '@lemma': 'zootie', '#text': 'zootie'}], entities=[], rhymes=[{'@rhymeTarget': 'e11730_n_1', '@position': '15', '@rhymeTargetWord': 'zootie', '@rhymeTargetPosition': '47', '#text': 'cutie'}], spot_uri="abc123")

        self.zootie_example_dict1 = self.zootie_sense_dict['examples']['example'][1]
        self.zootie_example_nt1 = ExampleParsed(primary_artists='Black Sheep', song_title='We Boys', featured_artists=['Legion, The'], release_date='1994-12-06', release_date_string='1994-12-06', album='Non-Fiction', lyric_text='One love with the bang, riding with the zootie', xml_id='5033', xrefs=[], rfs=[], entities=[], rhymes=[], spot_uri="abc123")

        self.zootie_song_nt = SongParsed(xml_id='3470', slug='beastie-boys-hey-ladies', title='Hey Ladies', artist_name='Beastie Boys', artist_slug='beastie-boys', release_date='1989-07-25', release_date_string='1989-07-25', album="Paul's Boutique", spot_uri="abc123")
        self.zootie_song_nt1 = SongParsed(xml_id='5033', slug='black-sheep-we-boys', title="We Boys", artist_name="Black Sheep", artist_slug='black-sheep', release_date='1994-12-06', release_date_string='1994-12-06', album='Non-Fiction', spot_uri="abc123")
