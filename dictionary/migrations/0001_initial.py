# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-19 17:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=1000, null=True, verbose_name='Domain Slug')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feat_artist', models.ManyToManyField(related_name='_song_feat_artist_+', to='dictionary.Artist')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='artist',
            name='featured_songs',
            field=models.ManyToManyField(related_name='_artist_featured_songs_+', to='dictionary.Song'),
        ),
        migrations.AddField(
            model_name='artist',
            name='image',
        ...
        migrations.AddField(
            model_name='artist',
            name='primary_songs',
            field=models.ManyToManyField(related_name='_artist_primary_songs_+', to='dictionary.Song'),
        ),
    ]
